<?php
	...
	*/
	...
	<div class="wrap">
		...
		<div class="dashboard_quick_link_container">
			<div>
			<form method="post" action="options.php">
				...
				<table class="form-table quick_dashboard_link_form">
					<tr valign="top"  class="quick_dashboard_link_widget_optionsection">
					<td scope="row" colspan="2"><h3>Enable Widget</h3></td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top"  class="quick_dashboard_link_widget_optionsection">
					<td scope="row" colspan="2"><h3>Widget Settings</h3></td>
					</tr>
					<tr valign="top">
